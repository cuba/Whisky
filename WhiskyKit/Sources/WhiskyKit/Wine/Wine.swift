...
public class Wine {
    ...
    public static func runWineProcess(
        ...
        try fileHandle.writeApplicaitonInfo()
        try fileHandle.writeInfo(for: bottle)
    ...
    public static func winVersion(bottle: Bottle) async throws -> WinVersion {
        let output = try await runWine(["winecfg", "-v"], bottle: bottle)
    ...
    private static func queryRegistyKey(bottle: Bottle, key: String, name: String,
